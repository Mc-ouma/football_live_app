...
class GetLeagueStandings implements UseCase<List<Standing>, LeagueStandingsParams> {
  final FootballRepository repository;

  GetLeagueStandings(this.repository);

  @override
  Future<Either<Failure, List<Standing>>> call(LeagueStandingsParams params) async {
